...
:: Android packaging
set AND_CERT_NAME="Starfield"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Starfield.p12
...
set IOS_PROVISION=cert\Starfield.mobileprovision
...
set APP_ID=air.Starfield

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Starfield
